...
(Replaces Power Preparation in core.)
...
* Cannot be used for wild magiccasting
...
* **Wild Magic Masochist:** allow soak attempts on the Wound for using wild magic, but this still needs Bennies in the usual way.
